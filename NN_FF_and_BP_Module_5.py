...
train_filename="Tweets_train.csv"
test_filename="Tweets_test.csv"

## !! Update this to YOUR path
DF_train = pd.read_csv("C:/Machine_learning/"+str(train_filename))
DF_test = pd.read_csv("C:/Machine_learning/"+str(test_filename))
#print(DF_test)

#set up the training data
#########################
## Set y to the label. Check the shape!
y = np.array(DF_train.iloc[:,200]).T
y = np.array([y]).T
#print("y is\n", y)
...
#####################
## Set y to the label. Check the shape!
y_test = np.array(DF_test.iloc[:,200]).T
